Download python 3 or higher
WHEN INSTALLING PYTHON. Make sure to select to add python to PATH. its one of the first selections on installation prompt

Installing python from the python foundation includes pip so you can do pip install -r requirements.txt
